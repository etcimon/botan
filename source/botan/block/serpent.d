...
enum string SBoxE1(string B0, string B1, string B2, string B3) =
    `{` ~ B3 ~ ` ^= ` ~ B0 ~ `;
    auto B4 = ` ~ B1 ~ `;
    ` ~ B1 ~ ` &= ` ~ B3 ~ `;
    B4 ^= ` ~ B2 ~ `;
...
enum string SBoxE2(string B0, string B1, string B2, string B3) =
    `{` ~ B0 ~ ` = ~` ~ B0 ~ `;
    ` ~ B2 ~ ` = ~` ~ B2 ~ `;
    auto B4 = ` ~ B0 ~ `;
    ` ~ B0 ~ ` &= ` ~ B1 ~ `;
...
enum string SBoxE3(string B0, string B1, string B2, string B3) =
    `{auto B4 = ` ~ B0 ~ `;
    ` ~ B0 ~ ` &= ` ~ B2 ~ `;
    ` ~ B0 ~ ` ^= ` ~ B3 ~ `;
    ` ~ B2 ~ ` ^= ` ~ B1 ~ `;
...
enum string SBoxE4(string B0, string B1, string B2, string B3) =
    `{auto B4 = ` ~ B0 ~ `;
    ` ~ B0 ~ ` |= ` ~ B3 ~ `;
    ` ~ B3 ~ ` ^= ` ~ B1 ~ `;
    ` ~ B1 ~ ` &= B4;
...
enum string SBoxE5(string B0, string B1, string B2, string B3) =
    `{` ~ B1 ~ ` ^= ` ~ B3 ~ `;
    ` ~ B3 ~ ` = ~` ~ B3 ~ `;
    ` ~ B2 ~ ` ^= ` ~ B3 ~ `;
    ` ~ B3 ~ ` ^= ` ~ B0 ~ `;
...
enum string SBoxE6(string B0, string B1, string B2, string B3) =
    `{` ~ B0 ~ ` ^= ` ~ B1 ~ `;
    ` ~ B1 ~ ` ^= ` ~ B3 ~ `;
    ` ~ B3 ~ ` = ~` ~ B3 ~ `;
    auto B4 = ` ~ B1 ~ `;
...
enum string SBoxE7(string B0, string B1, string B2, string B3) =
    `{` ~ B2 ~ ` = ~` ~ B2 ~ `;
    auto B4 = ` ~ B3 ~ `;
    ` ~ B3 ~ ` &= ` ~ B0 ~ `;
    ` ~ B0 ~ ` ^= B4;
...
enum string SBoxE8(string B0, string B1, string B2, string B3) =
    `{auto B4 = ` ~ B1 ~ `;
    ` ~ B1 ~ ` |= ` ~ B2 ~ `;
    ` ~ B1 ~ ` ^= ` ~ B3 ~ `;
    B4 ^= ` ~ B2 ~ `;
...
*/
enum string key_xor(ubyte round) =
    `B0 ^= m_round_key[4*` ~ round.stringof ~ `  ];
