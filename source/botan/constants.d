...
enum SKIP_TRANSFORM_TEST = true;
enum SKIP_X509_TEST = true;
enum SKIP_BLOCK_TEST = true;
enum SKIP_CVC_TEST = true; // TODO: EAC11 ECDSA Key decoding
enum SKIP_CRYPTOBOX_TEST = true;
enum SKIP_RFC3394_TEST = true;
enum SKIP_TSS_TEST = true;
enum SKIP_HASH_TEST = true;
enum SKIP_KDF_TEST = true;
enum SKIP_COMPRESSION_TEST = true;
enum SKIP_MAC_TEST = true;
enum SKIP_BIGINT_TEST = true;
enum SKIP_EC_GFP_TEST = true;
enum SKIP_AEAD_TEST = true;
enum SKIP_OCB_TEST = true;
enum SKIP_CIPHER_MODE_TEST = true;
enum SKIP_BCRYPT_TEST = true;
enum SKIP_PASSHASH9_TEST = true;
enum SKIP_PBKDF_TEST = true;
enum SKIP_HKDF_TEST = true;
enum SKIP_CURVE25519_TEST = true;
enum SKIP_DH_TEST = true;
enum SKIP_DLIES_TEST = true;
enum SKIP_DSA_TEST = true;
enum SKIP_ECDH_TEST = true;
enum SKIP_ECDSA_TEST = false;
enum SKIP_ELGAMAL_TEST = true;
enum SKIP_GOST_TEST = true;
enum SKIP_NR_TEST = true;
enum SKIP_RFC6979_TEST = true;
enum SKIP_RSA_TEST = true;
enum SKIP_RW_TEST = true;
enum SKIP_X509_KEY_TEST = true;
enum SKIP_RNG_TEST = true;
enum SKIP_STREAM_CIPHER_TEST = true;
enum SKIP_TLS_TEST = true;
...
version(Serpent_x86_32)  {    enum BOTAN_HAS_SERPENT_X86_32 = true;    static assert(BOTAN_HAS_X86_ARCH, ERR_ARCH);      }
