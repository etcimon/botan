...
public:
    ...
    */
    ...
    override bool loadFromServerInfo(in TLSServerInformation server, ref TLSSession session)
    {
                        ...
                        ref size_t check_val)
{
	...
	auto key = pbkdf.deriveKey(32 + 2, passphrase, salt, salt_len, iterations);
    SecureVector!ubyte x = key.bitsOf();
